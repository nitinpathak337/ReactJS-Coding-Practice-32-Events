...
class Events extends Component {
  ...
  changeEvent = id => {
    const eventSelected = eventsList.filter(eachItem => eachItem.id === id)
    console.log(eventSelected)
    this.setState({registrationStatus: eventSelected[0].registrationStatus})
  }
  ...
  render() {
    ...
    return (
      <div className="bg">
        ...
        <ActiveEventRegistrationDetails registration={registrationStatus} />
      </div>
    )
  }
}
